...
import com.mozilla.phabricator.conduit.RevisionAttachments
import com.mozilla.phabricator.conduit.RevisionConstraints
import com.mozilla.phabricator.conduit.collectList
...
class RevisionsManager(
    ...
    private suspend fun fetchRevisions(
        ...
        limit: Int,
    ): List<com.mozilla.phabricator.conduit.model.Revision> =
        session.client
            .searchRevisions(
